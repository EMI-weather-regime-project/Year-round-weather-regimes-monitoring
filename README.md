...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
&nbsp;
![Image locale](archives/images_documentation/figure_courbes21.png)
&nbsp;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
&nbsp;
![Image locale](archives/images_documentation/figure_courbes3.png)
&nbsp;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
&nbsp;
![Image locale](archives/images_documentation/figure_courbes4.png)
